...
14 Fahrzeuge (Autos, Taxis und Busse) folgen festen Fahrspuren, zwei Boote fahren vor der Küste, vier Menschen spazieren auf der Promenade und ein Zeppelin zieht hinter der Skyline vorbei. Strandliegen, Sonnenschirme und Badegäste ergänzen den Strand. Jede Runde erhält eine leicht variierte Tageszeit: Morgengrauen, Vormittag, Mittag, Nachmittag oder Sonnenuntergang über dem Meer. Sonnenstand, Lichtfarbe, Himmel, Wasserreflex und Fensterbelegung passen zusammen; die sichtbare Sonne und ihr Trefferbereich verwenden dieselbe Position. Tageszeit und Sonnenposition ergeben sich ohne zusätzliche Zufallszahlen aus Runde und Stadt und bleiben nach Neuladen gleich.

Mehr indirektes Umgebungslicht und ein geringerer Anteil direkten Sonnenlichts halten auch die abgewandten Fassaden erkennbar, ohne den Sonnenstand oder die Gebäudeschatten zu verlieren. Bei Sonnenauf- und -untergang schalten Straßen- und Promenadenlaternen, Hauseingangsleuchten, Scheinwerfer und Rücklichter der Fahrzeuge sowie Positionslichter der Boote ein. Kleine, weich auslaufende Lichtflächen beleuchten den Boden unter Laternen, an Eingängen und vor Fahrzeugen. Tagsüber bleiben diese Flächen unsichtbar. Die Lichtquellen nutzen die vorhandenen Stadt- und Fahrzeugpuffer; es gibt keine zusätzlichen Zeichenaufrufe oder Schattenkarten je Lampe. Die Lichtflächen sind eine günstige Darstellung, keine vollständige Simulation lokaler Lichtausbreitung.

Eine zwischengespeicherte Schattenkarte bildet Gebäude, Dachdetails, Bäume und Schäden auf Straßen, Fassaden und Grünflächen ab. Neun Tiefenvergleiche glätten die Schattenränder. Die Karte (1024 × 1024, RGBA plus 16-Bit-Tiefe, ca. 6 MiB) wird nur beim Stadtaufbau oder nach Schäden aktualisiert: ein zusätzlicher Zeichenaufruf in diesen Bildern, weiterhin drei in normalen Bildern. Bewegte Dekoration wirft keine eigenen Schatten. Ohne ausreichende Shader-Präzision oder vollständiges Schattenziel bleibt die direkte Beleuchtung nutzbar. Im Replay wird vor dem Einschlag nur die direkte Beleuchtung verwendet, damit der neue Krater keinen Schatten auf den alten Gebäudezustand wirft.

Fenster verwenden unabhängige, deterministische Belegungen je Fensterfläche statt periodischer Zeilenmuster. Einzelne Fenster wechseln mit versetzten Intervallen von 28–90 Sekunden sanft ihre Beleuchtung; in der Dämmerung sind mehr belegt als mittags. Pause und reduzierte Bewegung frieren diese Wechsel ohne Aufholsprung ein. Dafür sind weder zusätzliche Geometrie-Uploads noch Zeichenaufrufe nötig. Der Nebel beginnt erst außerhalb der Stadt und hängt nicht mehr vom Kameraabstand ab.
...
Die 21 Akteure teilen sich einen wiederverwendeten GPU-Puffer mit 2.752 Dreiecken und genau einem zusätzlichen Zeichenaufruf. Modelle werden einmal erzeugt; pro Bild werden nur ihre Positionen und Normalen in einem vorhandenen Array aktualisiert. Im Stillstand entfallen auch diese Uploads. Es gibt keine neuen Bibliotheken, externen Grafikdateien oder Partikelsysteme.
